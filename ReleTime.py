...
if platform.system() == "Windows":
    db = SQLighter("log\BotPiP.db")
    logger.add("log\ReleTime.log", format="{time} {level} {message}", level="DEBUG", rotation="10 MB", compression="zip")
else:
    db = SQLighter("/home/bots/BotPiP/BotPiP.db")
    logger.add("/home/bots/BotPiP/log/ReleTime.log", format="{time} {level} {message}", level="DEBUG", rotation="10 MB", compression="zip")
