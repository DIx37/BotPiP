...
def check_weather():
    ...
    try:
        ...
        if weather["weather"][0]["main"] in code_to_smile:
            ...
            weather_now['weather_weather'] = weather["weather"][0]["description"].title() + wd
        else:
            weather_now['weather_weather'] = weather["weather"][0]["description"].title()
...
# print(check_weather_new()["sunset"])
