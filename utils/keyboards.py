...
def rekup_pri_menu(user):
    ...
    if db.check_user_acess(user, "rekup_pri_menu", "banketniy_zal"):
        ...
        rekup_pri_menu.add(banketniy_zal)
    ...
    if db.check_user_acess(user, "rekup_pri_menu", "oranjereya"):
        ...
        rekup_pri_menu.insert(oranjereya)
    main_menu = InlineKeyboardButton(text="Назад", callback_data="main_menu")
...
#         l24_xml = LJ.l2_xml_read_all(Laurent_IP_Pool24)
#         print(l24_xml[3][0])
#         if l24_xml[3][0] == "0":
...
def banketniy_zal_menu(user):
    ...
    if pusk_stop_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if pusk_stop_now == "0":
            pusk_stop = InlineKeyboardButton(text="🟢 Запустить", callback_data=callback_rap.new(number="None", action="pusk", IP=Pixel_IP30))
            banketniy_zal_menu.insert(pusk_stop)
        elif pusk_stop_now == "1":
            pusk_stop = InlineKeyboardButton(text="🔴 Остановить", callback_data=callback_rap.new(number="None", action="stop", IP=Pixel_IP30))
            banketniy_zal_menu.insert(pusk_stop)
    ...
    if zima_leto_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if zima_leto_now == "0":
            zima = InlineKeyboardButton(text="❄️ Зима", callback_data=callback_rap.new(number="None", action="zima", IP=Pixel_IP30))
            banketniy_zal_menu.add(zima)
            auto = InlineKeyboardButton(text="Авто", callback_data=callback_rap.new(number="None", action="auto", IP=Pixel_IP30))
            banketniy_zal_menu.insert(auto)
        elif zima_leto_now == "1":
            leto = InlineKeyboardButton(text="☀️ Лето", callback_data=callback_rap.new(number="None", action="leto", IP=Pixel_IP30))
    ...
    if sbros_error_now == "WinError 10054" or sbros_error_now == "N/A":
        ...
        if sbros_error_now == "1":
            sbros_error = InlineKeyboardButton(text="Сбросить аварию", callback_data=callback_rap.new(number="None", action="sbros_error", IP=Pixel_IP30))
    ...
    if stop_start_vv_now == "WinError 10054" or stop_start_vv_now == "N/A":
        ...
        if stop_start_vv_now == "0":
            stop_vv = InlineKeyboardButton(text="Остановить ВВ", callback_data=callback_rap.new(number="None", action="stop_vv", IP=Pixel_IP30))
            banketniy_zal_menu.add(stop_vv)
        elif stop_start_vv_now == "1":
            start_vv = InlineKeyboardButton(text="Включить ВВ", callback_data=callback_rap.new(number="None", action="start_vv", IP=Pixel_IP30))
    ...
    if temp_ust_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if temp_ust_now > 16:
            ust_minus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now - 1), callback_data=callback_rap.new(number=temp_ust_now - 1, action="ust_minus", IP=Pixel_IP30))
            banketniy_zal_menu.add(ust_minus)
        if temp_ust_now < 30:
            ust_plus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now + 1), callback_data=callback_rap.new(number=temp_ust_now + 1, action="ust_plus", IP=Pixel_IP30))
    ...
    if set_speed_ventP_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventP_now > 400:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventP_now - 100, action="set_speed_ventP_minus", IP=Pixel_IP30))
            banketniy_zal_menu.add(set_speed_ventP)
        if set_speed_ventP_now < 1000:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventP_now + 100, action="set_speed_ventP_plus", IP=Pixel_IP30))
            if set_speed_ventP_now == 400:
                banketniy_zal_menu.add(set_speed_ventP)
            else:
    ...
    if set_speed_ventV_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventV_now > 400:
            set_speed_ventV = InlineKeyboardButton(text="Скорость ВВ:   " + str(round(set_speed_ventV_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventV_now - 100, action="set_speed_ventV_minus", IP=Pixel_IP30))
            banketniy_zal_menu.add(set_speed_ventV)
        if set_speed_ventV_now < 1000:
            set_speed_ventV = InlineKeyboardButton(text="Скорость ВВ:   " + str(round(set_speed_ventV_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventV_now + 100, action="set_speed_ventV_plus", IP=Pixel_IP30))
            if set_speed_ventV_now == 400:
                banketniy_zal_menu.add(set_speed_ventV)
            else:
...
def podval_menu(user):
    ...
    if pusk_stop_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if pusk_stop_now == "0":
            pusk_stop = InlineKeyboardButton(text="🟢 Запустить", callback_data=callback_rap.new(number="None", action="pusk", IP=Pixel_IP31))
            podval_menu.insert(pusk_stop)
        elif pusk_stop_now == "1":
            pusk_stop = InlineKeyboardButton(text="🔴 Остановить", callback_data=callback_rap.new(number="None", action="stop", IP=Pixel_IP31))
            podval_menu.insert(pusk_stop)
    ...
    if zima_leto_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if zima_leto_now == "0":
            zima = InlineKeyboardButton(text="❄️ Зима", callback_data=callback_rap.new(number="None", action="zima", IP=Pixel_IP31))
            podval_menu.add(zima)
            auto = InlineKeyboardButton(text="Авто", callback_data=callback_rap.new(number="None", action="auto", IP=Pixel_IP31))
            podval_menu.insert(auto)
        elif zima_leto_now == "1":
            leto = InlineKeyboardButton(text="☀️ Лето", callback_data=callback_rap.new(number="None", action="leto", IP=Pixel_IP31))
    ...
    if sbros_error_now == "WinError 10054" or sbros_error_now == "N/A":
        ...
        if sbros_error_now == "1":
            sbros_error = InlineKeyboardButton(text="Сбросить аварию", callback_data=callback_rap.new(number="None", action="sbros_error", IP=Pixel_IP31))
    ...
    if temp_ust_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if temp_ust_now > 16:
            ust_minus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now - 1), callback_data=callback_rap.new(number=temp_ust_now - 1, action="ust_minus", IP=Pixel_IP31))
            podval_menu.add(ust_minus)
        if temp_ust_now < 30:
            ust_plus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now + 1), callback_data=callback_rap.new(number=temp_ust_now + 1, action="ust_plus", IP=Pixel_IP31))
    ...
    if set_speed_ventP_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventP_now < 400:
            set_speed_ventP_now = 400
        if set_speed_ventP_now > 400:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventP_now - 100, action="set_speed_ventP_minus", IP=Pixel_IP31))
            podval_menu.add(set_speed_ventP)
        if set_speed_ventP_now < 1000:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventP_now + 100, action="set_speed_ventP_plus", IP=Pixel_IP31))
            if set_speed_ventP_now == 400:
                podval_menu.add(set_speed_ventP)
            else:
...
def kuhnya_menu(user):
    ...
    if pusk_stop_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if pusk_stop_now == "0":
            pusk_stop = InlineKeyboardButton(text="🟢 Запустить", callback_data=callback_rap.new(number="None", action="pusk", IP=Pixel_IP32))
            kuhnya_menu.insert(pusk_stop)
        elif pusk_stop_now == "1":
            pusk_stop = InlineKeyboardButton(text="🔴 Остановить", callback_data=callback_rap.new(number="None", action="stop", IP=Pixel_IP32))
            kuhnya_menu.insert(pusk_stop)
    ...
    if zima_leto_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if zima_leto_now == "0":
            zima = InlineKeyboardButton(text="❄️ Зима", callback_data=callback_rap.new(number="None", action="zima", IP=Pixel_IP32))
            kuhnya_menu.add(zima)
            auto = InlineKeyboardButton(text="Авто", callback_data=callback_rap.new(number="None", action="auto", IP=Pixel_IP32))
            kuhnya_menu.insert(auto)
        elif zima_leto_now == "1":
            leto = InlineKeyboardButton(text="☀️ Лето", callback_data=callback_rap.new(number="None", action="leto", IP=Pixel_IP32))
    ...
    if sbros_error_now == "WinError 10054" or sbros_error_now == "N/A":
        ...
        if sbros_error_now == "1":
            sbros_error = InlineKeyboardButton(text="Сбросить аварию", callback_data=callback_rap.new(number="None", action="sbros_error", IP=Pixel_IP32))
    ...
    if temp_ust_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if temp_ust_now > 16:
            ust_minus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now - 1), callback_data=callback_rap.new(number=temp_ust_now - 1, action="ust_minus", IP=Pixel_IP32))
            kuhnya_menu.add(ust_minus)
        if temp_ust_now < 30:
            ust_plus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now + 1), callback_data=callback_rap.new(number=temp_ust_now + 1, action="ust_plus", IP=Pixel_IP32))
    ...
    if set_speed_ventP_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventP_now < 400:
            set_speed_ventP_now = 400
        if set_speed_ventP_now > 400:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventP_now - 100, action="set_speed_ventP_minus", IP=Pixel_IP32))
            kuhnya_menu.add(set_speed_ventP)
        if set_speed_ventP_now < 1000:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventP_now + 100, action="set_speed_ventP_plus", IP=Pixel_IP32))
            if set_speed_ventP_now == 400:
                kuhnya_menu.add(set_speed_ventP)
            else:
...
def gostinaya_menu(user):
    ...
    if pusk_stop_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if pusk_stop_now == "0":
            pusk_stop = InlineKeyboardButton(text="🟢 Запустить", callback_data=callback_rap.new(number="None", action="pusk", IP=Pixel_IP33))
            gostinaya_menu.insert(pusk_stop)
        elif pusk_stop_now == "1":
            pusk_stop = InlineKeyboardButton(text="🔴 Остановить", callback_data=callback_rap.new(number="None", action="stop", IP=Pixel_IP33))
            gostinaya_menu.insert(pusk_stop)
    ...
    if zima_leto_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if zima_leto_now == "0":
            zima = InlineKeyboardButton(text="❄️ Зима", callback_data=callback_rap.new(number="None", action="zima", IP=Pixel_IP33))
            gostinaya_menu.add(zima)
            auto = InlineKeyboardButton(text="Авто", callback_data=callback_rap.new(number="None", action="auto", IP=Pixel_IP33))
            gostinaya_menu.insert(auto)
        elif zima_leto_now == "1":
            leto = InlineKeyboardButton(text="☀️ Лето", callback_data=callback_rap.new(number="None", action="leto", IP=Pixel_IP33))
    ...
    if sbros_error_now == "WinError 10054" or sbros_error_now == "N/A":
        ...
        if sbros_error_now == "1":
            sbros_error = InlineKeyboardButton(text="Сбросить аварию", callback_data=callback_rap.new(number="None", action="sbros_error", IP=Pixel_IP33))
    ...
    if temp_ust_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if temp_ust_now > 16:
            ust_minus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now - 1), callback_data=callback_rap.new(number=temp_ust_now - 1, action="ust_minus", IP=Pixel_IP33))
            gostinaya_menu.add(ust_minus)
        if temp_ust_now < 30:
            ust_plus = InlineKeyboardButton(text="Уставка t:   " + str(temp_ust_now + 1), callback_data=callback_rap.new(number=temp_ust_now + 1, action="ust_plus", IP=Pixel_IP33))
    ...
    if set_speed_ventP_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventP_now < 400:
            set_speed_ventP_now = 400
        if set_speed_ventP_now > 400:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventP_now - 100, action="set_speed_ventP_minus", IP=Pixel_IP33))
            gostinaya_menu.add(set_speed_ventP)
        if set_speed_ventP_now < 1000:
            set_speed_ventP = InlineKeyboardButton(text="Скорость ВП:   " + str(round(set_speed_ventP_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventP_now + 100, action="set_speed_ventP_plus", IP=Pixel_IP33))
            if set_speed_ventP_now == 400:
                gostinaya_menu.add(set_speed_ventP)
            else:
...
def oranjereya_menu(user):
    ...
    if pusk_stop_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if pusk_stop_now == "0":
            pusk_stop = InlineKeyboardButton(text="🟢 Запустить", callback_data=callback_rap.new(number="None", action="pusk", IP=Pixel_IP34))
            oranjereya_menu_menu.insert(pusk_stop)
        elif pusk_stop_now == "1":
            pusk_stop = InlineKeyboardButton(text="🔴 Остановить", callback_data=callback_rap.new(number="None", action="stop", IP=Pixel_IP34))
            oranjereya_menu_menu.insert(pusk_stop)
    ...
    if zima_leto_now == "WinError 10054" or pusk_stop_now == "N/A":
        ...
        if zima_leto_now == "0":
            zima = InlineKeyboardButton(text="❄️ Зима", callback_data=callback_rap.new(number="None", action="zima", IP=Pixel_IP34))
            oranjereya_menu_menu.add(zima)
            auto = InlineKeyboardButton(text="Авто", callback_data=callback_rap.new(number="None", action="auto", IP=Pixel_IP34))
            oranjereya_menu_menu.insert(auto)
        elif zima_leto_now == "1":
            leto = InlineKeyboardButton(text="☀️ Лето", callback_data=callback_rap.new(number="None", action="leto", IP=Pixel_IP34))
    ...
    if sbros_error_now == "WinError 10054" or sbros_error_now == "N/A":
        ...
        if sbros_error_now == "1":
            sbros_error = InlineKeyboardButton(text="Сбросить аварию", callback_data=callback_rap.new(number="None", action="sbros_error", IP=Pixel_IP34))
    ...
    if stop_start_vv_now == "WinError 10054" or stop_start_vv_now == "N/A":
        ...
        if stop_start_vv_now == "0":
            stop_vv = InlineKeyboardButton(text="Остановить ВВ", callback_data=callback_rap.new(number="None", action="stop_vv", IP=Pixel_IP34))
            oranjereya_menu_menu.add(stop_vv)
        elif stop_start_vv_now == "1":
            start_vv = InlineKeyboardButton(text="Включить ВВ", callback_data=callback_rap.new(number="None", action="start_vv", IP=Pixel_IP34))
    ...
    if temp_ust_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if temp_ust_now > 16:
            ust_minus = InlineKeyboardButton(text="➖ Уставка t:   " + str(temp_ust_now - 1), callback_data=callback_rap.new(number=temp_ust_now - 1, action="ust_minus", IP=Pixel_IP34))
            oranjereya_menu_menu.add(ust_minus)
        if temp_ust_now < 30:
            ust_plus = InlineKeyboardButton(text="➕ Уставка t:   " + str(temp_ust_now + 1), callback_data=callback_rap.new(number=temp_ust_now + 1, action="ust_plus", IP=Pixel_IP34))
    ...
    if set_speed_ventP_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventP_now < 400:
            set_speed_ventP_now = 400
        if set_speed_ventP_now > 400:
            set_speed_ventP = InlineKeyboardButton(text="➖ Скорость ВП:   " + str(round(set_speed_ventP_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventP_now - 100, action="set_speed_ventP_minus", IP=Pixel_IP34))
            oranjereya_menu_menu.add(set_speed_ventP)
        if set_speed_ventP_now < 1000:
            set_speed_ventP = InlineKeyboardButton(text="➕ Скорость ВП:   " + str(round(set_speed_ventP_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventP_now + 100, action="set_speed_ventP_plus", IP=Pixel_IP34))
            if set_speed_ventP_now == 400:
                oranjereya_menu_menu.add(set_speed_ventP)
            else:
    ...
    if set_speed_ventV_now == "WinError 10054" or temp_ust_now == "N/A":
        ...
        if set_speed_ventV_now < 400:
            set_speed_ventV_now = 400
        if set_speed_ventV_now > 400:
            set_speed_ventV = InlineKeyboardButton(text="➖ Скорость ВВ:   " + str(round(set_speed_ventV_now/10 - 10)), callback_data=callback_rap.new(number=set_speed_ventV_now - 100, action="set_speed_ventV_minus", IP=Pixel_IP34))
            oranjereya_menu_menu.add(set_speed_ventV)
        if set_speed_ventV_now < 1000:
            set_speed_ventV = InlineKeyboardButton(text="➕ Скорость ВВ:   " + str(round(set_speed_ventV_now/10 + 10)), callback_data=callback_rap.new(number=set_speed_ventV_now + 100, action="set_speed_ventV_plus", IP=Pixel_IP34))
            if set_speed_ventV_now == 400:
                oranjereya_menu_menu.add(set_speed_ventV)
            else:
